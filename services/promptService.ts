...
import { OUTLINE_PROMPT_TEMPLATE, MULTIPLE_HOOKS_PROMPT_TEMPLATE, CHAPTER_PROMPT_TEMPLATE, STYLE_ANALYSIS_PROMPT_TEMPLATE, DEFAULT_TITLE_PROMPT_TEMPLATE, COMPETITOR_ANALYSIS_TITLE_PROMPT_TEMPLATE, PLOT_IDEA_PROMPT_TEMPLATE, REGENERATE_HOOK_WITH_FEEDBACK_PROMPT_TEMPLATE, GENERATE_SIMILAR_TITLES_PROMPT_TEMPLATE, GENERATE_TITLES_FROM_SCRIPT_PROMPT_TEMPLATE, GENERATE_DESCRIPTION_PROMPT_TEMPLATE, GENERATE_TITLES_FROM_IDEA_PROMPT_TEMPLATE, GENERATE_TITLES_FROM_EXISTING_TITLE_PROMPT_TEMPLATE } from './prompts';
...
export const getTitlesFromScriptPrompt = (scriptText: string): string => {
    return GENERATE_TITLES_FROM_SCRIPT_PROMPT_TEMPLATE.replace('{script_text}', scriptText);
};

export const getTitlesFromExistingTitlePrompt = (existingTitle: string): string => {
    return GENERATE_TITLES_FROM_EXISTING_TITLE_PROMPT_TEMPLATE.replace('{existing_title}', existingTitle);
};

export const getDescriptionPrompt = (title: string, scriptText: string): string => {
    return GENERATE_DESCRIPTION_PROMPT_TEMPLATE
        .replace('{title}', title)
        .replace('{script_text}', scriptText);
};

export const getTitlesFromIdeaPrompt = (storyIdea: string): string => {
    return GENERATE_TITLES_FROM_IDEA_PROMPT_TEMPLATE.replace('{story_idea}', storyIdea);
};